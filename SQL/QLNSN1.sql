...
(
    ...
    CONSTRAINT FK_SANPHAM_NPP FOREIGN KEY (MaNPP) REFERENCES NHAPHANPHOI(MaNPP),
    CONSTRAINT FK_SANPHAM_THELOAI FOREIGN KEY (MaLoai) REFERENCES THELOAISANPHAM(MaLoai)
)
...
INSERT INTO CHITIETPHIEUNHAP(MaPhieuNhap, MaSP, SoLuong)
VALUES
('PN001', 'SP001', 10),
('PN002', 'SP002', 30),
('PN003', 'SP003', 20),
